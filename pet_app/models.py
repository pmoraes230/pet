...
# ALTERE ESTA LINHA: Importe o models do app onde estão o Tutor e o Pet
...
# --- Dentro de pet_app/models.py ---

# No pet_app/models.py

class Notificacao(models.Model):
    # Baseado na sua tabela 'pet_app_notificacao'
    mensagem = models.TextField()
    data_criacao = models.DateTimeField(auto_now_add=True)
    lida = models.BooleanField(default=False)
    tipo = models.CharField(max_length=20, default='sistema')
    # Foreign Keys
    tutor = models.ForeignKey(Tutor, on_delete=models.CASCADE, db_column='tutor_id', null=True)
    veterinario = models.ForeignKey(Veterinario, on_delete=models.CASCADE, db_column='veterinario_id')
    
    # Verifique se o tutor_id também está igual ao banco
    tutor = models.ForeignKey(
        'Tutor', 
        on_delete=models.CASCADE, 
        related_name='notificacoes_tutor', 
        null=True, 
        blank=True, 
        db_column='tutor_id' # <--- Verifique se no SQL você criou como tutor_id
    )
